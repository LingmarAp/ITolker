...
import cn.lingmar.factory.presenter.contact.PersonalContract;
import cn.lingmar.factory.presenter.contact.PersonalPresenter;
...
public class PersonalActivity extends PresenterToolbarActivity<PersonalContract.Presenter>
    ...
    private boolean mIsFollowUser = false;  // 是否已关注人
    ...
    public void onLoadDone(User user) {
        ...
        mFollows.setText(String.format(getString(R.string.label_follows), user.getFollowing()));
